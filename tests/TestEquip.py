...
class TestEquip(unittest.TestCase):
    ...
    def test_equip(self):
        ...
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip"])
    ...
    def test_equip_regular_item_room(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "envelope"])
        result_output = stdout.getvalue()
    ...
    def test_equip_consumable_item(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "bandage"])
        result_output = stdout.getvalue()
    ...
    def test_equip_direction(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "west"])
        result_output = stdout.getvalue()
    ...
    def test_equip_creature(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "dragon"])
        result_output = stdout.getvalue()
    ...
    def test_equip_inventory(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "inventory"])
        result_output = stdout.getvalue()
    ...
    def test_equip_key(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "key"])
        result_output = stdout.getvalue()
    ...
    def test_equip_key_ambiguous(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih1.execute_commands(["equip", "key"])
        result_output = stdout.getvalue()
    ...
    def test_equip_door(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["equip", "door"])
        result_output = stdout.getvalue()
    ...
    def test_equip_door_ambiguous(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih1.execute_commands(["equip", "door"])
        result_output = stdout.getvalue()
