...
class TestExamine(unittest.TestCase):
    ...
    def test_examine(self):
        ...
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine"])
    ...
    def test_examine_regular_item(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "envelope"])
        result_output = stdout.getvalue()
    ...
    def test_examine_consumable_item(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "bandage"])
        result_output = stdout.getvalue()
    ...
    def test_examine_equipment_weapon(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "sword"])
        result_output = stdout.getvalue()
    ...
    def test_examine_equipment_armour(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "helmet"])
        result_output = stdout.getvalue()
    ...
    def test_examine_direction(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "west"])
        result_output = stdout.getvalue()
    ...
    def test_examine_creature(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "dragon"])
        result_output = stdout.getvalue()
    ...
    def test_examine_inventory(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "inventory"])
        result_output = stdout.getvalue()
    ...
    def test_examine_key(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "key"])
        result_output = stdout.getvalue()
    ...
    def test_examine_key_ambiguous(self):
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih1.execute_commands(["examine", "key"])
        result_output = stdout.getvalue()
    ...
    def test_examine_door(self):
        ...
        stdout = io.StringIO()
        with contextlib.redirect_stdout(stdout):
            self.ih.execute_commands(["examine", "door"])
        result_output = stdout.getvalue()
